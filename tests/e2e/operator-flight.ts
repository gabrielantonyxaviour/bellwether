...
const paths = ["tests/e2e/operator-harness.ts", "tests/e2e/operator-flight.ts", "tests/e2e/operator.spec.ts", "web", "services", "scripts/deploy", "scripts/assets", "scripts/fork", "programs", "package.json", "pnpm-lock.yaml"]
